...
class RecursoController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        $recursoRepository = $em->getRepository('AppBundle:Recurso');
        ...
        $recursos = $recursoRepository->getRecursos()->getQuery()->getArrayResult();
        ...
        $extensiones = $recursoRepository->getExtensiones()->getQuery()->getArrayResult();
        ...
        $recursosQb = $recursoRepository->getReportes();
        ...
        return $this->render('AppBundle:recurso:index.html.twig', array(
    ...
    public function verPdfAction(Request $request, $id)
    {
        ...
        $reporte = $em->find('AppBundle:Recurso', $id);
